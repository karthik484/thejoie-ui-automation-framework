...
const paymentFailure = test ;

paymentFailure('Payment failure due to invalid payment details',async({browser})=>{
...
console.log(
    'Pay without saving count:',
    await paymentframe.locator('[name="pay_without_saving_card"]').count());
